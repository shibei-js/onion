...
// This file is derived from the tests in koa-compose
// In order to test the compatibility of Pipeline() with koa-compose
// Repo of koa-compose: https://github.com/koajs/compose
// Change:
//     1. Replace compose() with Pipeline()
//     2. Skip test: 'should only accept an array'
//     3. Use require('chai').expect
...
describe('Koa Compose', function () {
    ...
    //         err = e
    //     }
    //     return expect(err).to.be.an.instanceof(TypeError)
    // })
    ...
    it('should not get stuck on the passed in next', () => {
        ...
        return compose(middleware)(ctx, (ctx, next) => {
            ...
            expect(ctx).to.eql({ middleware: 1, next: 1 })
        })
    })
